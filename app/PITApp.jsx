  ...
  function DOPBtn({ top = false }) {
    return (
      <button
        ...
        onClick={() => window.open(`http://localhost:5173/?hub_user=${currentUser.id}`, '_blank')}
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <span style={{ fontSize: 15, fontWeight: 900, color: '#000',
              letterSpacing: 1, textTransform: 'uppercase' }}>Never Twice</span>
            <span style={{ fontSize: 11, fontWeight: 600, color: '#000',
              letterSpacing: 0.3 }}>Miss one — never miss the second.</span>
          </div>
